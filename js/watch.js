(function(g, h, C) {
    ...
    function Ba(a, b) {
        ...
        if (.01 > Math.random()) try {
            var d = a && a.message || "";
            (c = -1 < d.indexOf("network error occurred") || -1 < d.indexOf("send beacon") && -1 < d.indexOf("Content Security Policy")) || (new ha).log("jserrs", va, a.message, b, K.href, "", "string" === typeof a.stack && a.stack.replace(/\n/g, "\\n"))
        } catch (f) {}
    }
    ...
    function tb(a, b, c, d, f) {
        ...
        function x(a) {
            if (!a.nodeName) return a[J] = -1, null;
            var b = +a[J];
            ...
            var d = 0,
                ...
                e = f && f[J] ? f[J] : 0;
            0 > e && (e = 0);
            var Ca = a.nodeName.toUpperCase(),
                g = vb[Ca];
            g || (c |= 2);
            var t = p.getElementNeighborPosition(a);
            t || (c |= 4);
            var x = p.getElementRegion(a);
            (f = f ? p.getElementRegion(f) : null) && x[0] == f[0] && x[1] == f[1] && x[2] == f[2] && x[3] == f[3] && (c |= 8);
            fa[b].pos = x[0] + "x" + x[1];
            fa[b].size = x[2] + "x" + x[3];
            a.id && "string" == typeof a.id && (c |= 32);
            (f = p.calcTextChecksum(a)) && (c |= 16);
            var S = p.calcAttribChecksum(a);
            S && (d |= 2);
            a: {
                var w = p.getElementChildren(p.getElementParent(a),
                    a.tagName);
                for (var h = 0; h < w.length; h++)
                    if ((!w[h].id || "string" != typeof w[h].id) && p.calcAttribChecksum(w[h]) == S && p.calcTextChecksum(w[h]) == f) {
                        w = !0;
                        break a
                    }
                w = !1
            ...
            if (a[J]) a: {
                ...
                if (0 < c) {
                    ...
                    var f = fa[c],
                        e = a[0] + "x" + a[1],
                        q = a[2] + "x" + a[3];
                    e != f.pos && (f.pos = e, n(d, 9), k(d, b), k(d, c), k(d, a[0]),
                        k(d, a[1]));
                    q != f.size && (f.size = q, n(d, 10), k(d, b), k(d, c), k(d, a[2]), k(d, a[3]));
                    if (d.length) {
                        b = d;
                        break a
                    }
                ...
                b = null
            } else(b = p.getElementParent(a)) && M(b), a[J] = Wa, fa[Wa] = {}, Wa++, b = x(a), xa.append(b, void 0), b = K(a);
            xa.append(b, void 0)
        }
            ...
            if (b && "SCROLLBAR" != b.nodeName) {
                if (/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b.tagName))
                    if (b[J]) M(b);
                        ...
                        if (c) {
                            c = c.elements;
                            for (var d = c.length, f = 0; f < d; f++) /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(c[f].tagName) && !c[f][J] && M(c[f])
                        } else M(b)
                    } else M(b);
                H(r, [m.nowEventTime(), a.type, b, A.getPos(a), a.which, a.button])
            }
        }
        ...
        function ca() {
            var a = p.getDocumentScroll(),
                b = m.nowTime();
            10 > b - gb || 10 > Math.abs(a[0] - Za[0]) && 10 > Math.abs(a[1] - Za[1]) || (gb = b, Za = a, H(Da, [m.nowEventTime(), a]))
        }
        ...
        function W(a) {
            if (a = A.getTarget(a)) {
                ...
                la[a.localId] = c;
                a !== h && (M(a), H(Va, [m.nowEventTime(), c, a]))
            }
        }

        function ja() {
            H(v, [m.nowEventTime(), p.getViewportSize(), p.getDocumentSize()])
        }
        ...
        function na(a, b, c) {
            a = A.getTarget(a);
            var d = X(a);
            d.ignore || !d.forceRecord && (d.isPrivate && f.get("isEU") || L(a)) || (M(a), H(C, [m.nowEventTime(), b, c, a, d.privateFlag]))
        }
        ...
        function ia() {
            ...
            if ("string" ==
                ...
                if (c) {
                    a = X(c).privateFlag || L(c, !0);
                    c = c.getElementsByTagName("*");
                    for (var d = 0; d < c.length && !a;) a = X(c[d]).privateFlag || L(c[d], !0), d++;
                    b != bb && (bb = b, b = a ? e.map(function() {
                        return Fa.obfuscatedSymbol
                    }, b.split("")).join("") : b, H(yb, [m.nowEventTime(), b]))
                }
            }
        }

        function Y() {
            ma || (ma = !0, bb && H(oa, [m.nowEventTime()]), e.setTimeout(function() {
                ma = !1
            }, 1, "wvl.copy"))
        }

        function T() {
            P || (P = !0, H(zb, [m.nowEventTime()]))
        }

        function qa() {
            P && (P = !1, H(wa, [m.nowEventTime()]))
        }
        ...
        function w(a) {
            if ((a = A.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName)) {
                if (a[J]) M(a);
                    ...
                    if (b) {
                        b = b.elements;
                        for (var c = b.length, d = 0; d < c; d++) /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[d].tagName) && !b[d][J] && M(b[d])
                    } else M(a)
                }
                H(G, [m.nowEventTime(), a])
            }
        }

        function Q(a) {
            (a = A.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (M(a), H(y, [m.nowEventTime(), a]))
        }

        function aa(a) {
            if ((a = A.getTarget(a)) &&
                !N(a) && !L(a) && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
                var b = X(a),
                ...
                M(a);
                H(B, [m.nowEventTime(), a, c, b.privateFlag])
            }
        }

        function E(a) {
            if ((a = A.getTarget(a)) && !R(a) && "FORM" == a.nodeName) {
                for (var b = a.elements, c = 0; c < b.length; c++) p.isEmptyField(b[c]) || M(b[c]);
                H(O, [m.nowEventTime(), a], !0)
            }
        }
        ...
        function ka(a) {
            ...
            if (a.touches && a.touches.length) {
                ...
                if (b && b != h) {
                    M(b);
                    for (var c = 0; c < a.touches.length; c++) H(r, [m.nowEventTime(), "touch", b, [a.touches[c].pageX, a.touches[c].pageY], 0, 0])
                }
            }
        }
        ...
        function ra(a) {
            ...
            if (b) {
                ...
                c && (M(b), H(xb, [m.nowEventTime(), b, A.getPos(a), c]))
            }
        }

        function ib(a) {
            (a = A.getTarget(a)) && "BODY" == a.tagName && xa.append([], !0)
        }
        var xa = new Ma({
                protocol: a,
                globalConfig: f,
        ...
        if (!e.isMetrikaPlayer()) {
            l.on(h, "mousemove", Z);
            l.on(h, "click,dblclick,mousedown", I);
            l.on(h, "mouseup", D);
            l.on(g, "scroll", ca);
            if ("onmousewheel" in h) l.on(h, "mousewheel", ra);
            else l.on(h, "wheel", ra);
            l.on(g,
                "beforeunload", da);
            if (!Ab) l.on(g, "unload", da);
            l.on(g, "resize", ja);
            l.on(h, "keydown", pa);
            l.on(h, "keypress", ea);
            l.on(h, "copy", Y);
            ...
            h.attachEvent && !g.opera ? (l.on(h, "focusin", V), l.on(h, "focusout", S)) : (l.on(g, "focus", T), l.on(g, "blur", qa), l.on(h, "blur", qa));
            h.addEventListener ? (l.on(h, "scroll", W), l.on(h, "focus", w), l.on(h, "blur", Q), l.on(h, "change", aa), l.on(h, "submit", E)) : h.attachEvent && (l.on(h, "focusin", w), l.on(h, "focusout", Q), function() {
                for (var a =
        ...
        return {
            ...
            stop: function() {
                ...
                l.un(h, "mousedown", I);
                l.un(h, "mouseup", D);
                l.un(h, "mousewheel", ra);
                l.un(h, "wheel", ra);
                l.un(g, "scroll", ca);
                l.un(g, "beforeunload", da);
                l.un(g, "unload", da);
                l.un(g, "resize", ja);
                l.un(h, "keydown", pa);
                l.un(h, "keypress", ea);
                ...
                l.un(g, "blur", qa);
                l.un(h, "blur", qa);
                h.removeEventListener ? (l.un(h, "scroll", W), l.un(h, "focus", w), l.un(h, "blur", Q), l.un(h, "change", aa), l.un(h, "submit", E)) : h.detachEvent && (l.un(h, "focusin", w), l.un(h, "focusout", Q), function() {
            ...
            uploadPages: function(a, b) {
                function c() {
                    ...
                    l.un(g, "load", c);
                    for (var f = a.split(/\n/), n = z().href, e = /regexp:/, k = 0; k < f.length; k++) {
                        var q = f[k];
                        if (q)
                            if (e.test(q)) {
                                q = Na(q.replace(e, ""));
            ...
            uploadPage: u(function(f) {
                ...
                if ("html" === f) return f = new RegExp("\x3cscript [^\x3e]*?//" + F.host.replace(/\./g, "\\\\.") + "/watch/.*?\x3c/script\x3e", "gi"), x.sendContent(p.getDocumentHTML().replace(f, ""), q, d, Ga, Ha), !0;
    ...
    function ea() {
        return 0 == z().hostname.search(/^(.*\.)?((yandex(-team)?)\.(com?\.)?[a-z]+|(auto|kinopoisk|beru)\.ru|ya\.(ru|cc)|yadi\.sk|yastatic\.net|.*\.yandex)$/)
    }
        ...
        var ya = function(a) {
            ...
            var d = function(a) {
                ...
                return c(b, a), b.prototype.J = function() {
                    ...
                    var b = this.c;
                    return b.clearColor(0, 0, 0, 1), b.enable(b.DEPTH_TEST), b.depthFunc(b.LEQUAL), b.clear(b.COLOR_BUFFER_BIT | b.DEPTH_BUFFER_BIT),
                    "[" + a[0] + ", " + a[1] + "]"
            ...
            a = function() {
                ...
                return a.prototype.g = function() {
                    ...
                    if (!this.m || "https:" !== K.protocol || a) return "";
                    a = "";
            ...
            function k(a) {
                return g(a = c(a = g(a = c(a = g(a, [0, a[0] >>> 1]), [4283543511, 3981806797]), [0, a[0] >>> 1]), [3301882366, 444984403]), [0, a[0] >>> 1])
            }
            b.a = !0;
            b.hash = function(a, b) {
                a = a || "";
                ...
                var q = a.length % 16,
                    ...
                    h = [0, b];
                b = [0, b];
                for (var l, t, U = [2277735313, 289559509], p = [1291169091, 658871167], m = 0; m < n; m += 16) l = [255 & a.charCodeAt(m + 4) | (255 & a.charCodeAt(m + 5)) << 8 | (255 & a.charCodeAt(m + 6)) << 16 | (255 & a.charCodeAt(m + 7)) << 24, 255 & a.charCodeAt(m) | (255 & a.charCodeAt(m + 1)) << 8 | (255 & a.charCodeAt(m + 2)) << 16 | (255 & a.charCodeAt(m + 3)) << 24], t = [255 & a.charCodeAt(m + 12) | (255 & a.charCodeAt(m +
                    13)) << 8 | (255 & a.charCodeAt(m + 14)) << 16 | (255 & a.charCodeAt(m + 15)) << 24, 255 & a.charCodeAt(m + 8) | (255 & a.charCodeAt(m + 9)) << 8 | (255 & a.charCodeAt(m + 10)) << 16 | (255 & a.charCodeAt(m + 11)) << 24], h = d(c(h = d(h = f(h = g(h, c(f(c(l, U), 31), p)), 27), b), [0, 5]), [0, 1390208809]), b = d(c(b = d(b = f(b = g(b, c(f(c(t, p), 33), U)), 31), h), [0, 5]), [0, 944331445]);
                switch (l = [0, 0], t = [0, 0], q) {
                    case 15:
                    ...
                    case 9:
                        b = g(b, c(f(c(g(t, [0, a.charCodeAt(m + 8)]), p), 33), U));
                    case 8:
                    ...
                    case 1:
                        h = g(h, c(f(c(g(l, [0, a.charCodeAt(m)]), U), 31), p))
                }
                return h =
                    g(h, [0, a.length]), b = d(b = g(b, [0, a.length]), h = d(h, b)), h = k(h), b = d(b = k(b), h = d(h, b)), ("00000000" + (h[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (h[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[1] >>> 0).toString(16)).slice(-8)
            }
        }]);
        ya = ya["default"]
    } catch (a) {
    ...
    e.setTimeout = function(a, b, c) {
        return e.getNativeFunction("setTimeout")(u(a, c || "setTimeout"),
            b)
    };
    var l = B.inherit({
        ...
        on: function(a, b, c, d, f) {
            ...
            for (k = 0; k < e; k++) {
                ...
                n[n.length] = [a, h, c, d, f, t];
                a.addEventListener ? a.addEventListener(h, t, l._prepOpts(f)) : a.attachEvent && a.attachEvent("on" + h, t)
            }
        },
            ...
            send: function(a,
                ...
                g.isDisabled() ? n.call(d) : function t(a) {
                    if (a < this.transports.length) try {
                        ...
                        Ba(wb, "send by " + (c && c.id)), t.call(this, a + 1)
                    }
                }.call(this,
                    0)
            }
            ...
            if (a.hasOwnProperty(n))
                if (d = a[n], e.isArray(d))
                    for (k = 0; k < d.length; k++) c.push({
                        key: n,
                        value: encodeURIComponent(n) + "\x3d" + encodeURIComponent(String(d[k]))
                    });
                else c.push({
                    key: n,
    ...
    var T = Y.inherit({
            ...
            request: function(a, b, c, d) {
                ...
                n.style.top = "-99999px";
                var k = ['\x3ciframe name\x3d"', g, '"\x3e\x3c/iframe\x3e', '\x3cform action\x3d"',
                    this._buildUrl(a, b.get), '" method\x3d"post" target\x3d"', g, '" enctype\x3d"', this.enctype, '"\x3e'
                ];
                ...
                var h = n.getElementsByTagName("form")[0];
    ...
    e.toJSON = function(a) {
        ...
        switch (a.constructor) {
            ...
            case Object:
                c = [];
                for (d in a) a.hasOwnProperty(d) && a[d] !== C && (c[c.length] = e.toJSON(d) + ":" + e.toJSON(a[d]));
                return "{" + c.join(",") + "}";
            default:
    ...
    var I = B.inherit({
        ...
        set: function(a, b) {
            if (this.isEnabled()) try {
                !b ||
                b && e.isArray(b) && !b.length ? this.remove(a) : this._ls.setItem(this._getLsKey(a), e.toJSON(b))
            } catch (c) {}
        },
        get: function(a) {
            if (this.isEnabled()) try {
        ...
        getStorageId: function() {
            var a = this.get("lsid");
            a || (a = Math.round(Math.random() * m.getMs()),
                this.set("lsid", a));
            return a
        },
    ...
    var L = {
        ...
        G = B.inherit({
            ...
            _initComponent: function() {
                var a;
                G.superclass._initComponent.apply(this, arguments);
                this._domain = null;
            ...
            create: function(a, b, c) {
                ...
                this._domain && a.push("domain\x3d" +
                    this._domain);
                a.push("path\x3d/");
                try {
                    h.cookie = a.join(";")
    ...
    r.isSafariWebView = u(function() {
        var a = navigator.userAgent || "";
        return navigator.vendor && -1 < navigator.vendor.indexOf("Apple") && (!a.match(/Safari/) && a.match(/Mobile/) || a.match(/CFNetwork\/[0-9][0-9.]*.*Darwin\/[0-9][0-9.]*/) ||
            -1 !== a.indexOf("FB_IAB") || -1 !== a.indexOf("FBAV") || -1 !== a.indexOf("OKApp") || -1 !== a.indexOf("GSA/"))
    }, "isSafariWebView");
    r.isSafari = function() {
        try {
    ...
    var la = {
            ...
            getZZ: function() {
                return this._storage.get(this.key) ?
                    this._storage.get(this.key) : this.zz
            },
            getPP: function() {
            ...
            checkVersion: function() {
                ...
                return !((r.isIOS() ||
                    10 <= a[0] && 13 <= a[2]) && r.isSafari()) || r.isSafariWebView()
            },
            noop: function() {},
            genPu: function(a) {
            ...
            initPU: function(a, b) {
                var c = this;
                b.get("pu") !== C || this.checkVersion() || (this.globalConfig = b, b.setSafe("pu", null), a.addHandler("gpu-get", function() {
                    return {
                        type: "gpu-get",
                        pu: b.get("pu")
                    }
            ...
            initPP: u(function(a) {
                var b =
                    g.RTCPeerConnection || g.mozRTCPeerConnection || g.webkitRTCPeerConnection;
                this.globalConfig = a;
                if (g.navigator.onLine && b && a.get("pp") == C && (this.globalConfig.setSafe("pp", null), b && b.prototype && b.prototype.constructor && b.prototype.constructor.name)) {
                    ...
                    if (e.isFunction(c.createOffer) && !c.createOffer.length) {
                        ...
                        c.onicecandidate = e.bind(this.onicecandidate,
                            this, c)
                    }
                }
            }, "rcinit"),
            initZZ: function() {
                ...
                if (!this.getZZ() && !this.checkVersion()) {
                    ...
                    b.src = F.protocol + "//" + F.host + L.decode(F.cross);
            ...
            onMessage: function(a) {
                a.data && a.data.substr && "__ym__zz" === a.data.substr(0, 8) && (this.zz = a.data.substr(8), p.removeNode(this.frame), this._storage.set(this.key, this.zz), l.un(g, "message", this.onMessage, this, {
                    passive: !1
            ...
            initFip: function() {
                if (Object.keys && !this.checkVersion() && !this._storage.get(this.fipKey)) {
                    var a = new ya(e.reduce(function(a, c) {
                        a[c] = 1;
                        return a
                    }, {}, this.fpFactors));
                    a = a.toString(!1).join("-");
        ...
        O = za.inherit({
            ...
            counterType: 0,
            retry: !1,
            transports: [Gb, ua, V, Hb],
            _initComponent: function() {
                O.superclass._initComponent.apply(this, arguments);
                this.retry && (this._storage = new I)
            },
            ...
            _sendSavedRequest: function(a, b, c, d, f) {
                ...
                if ("process" == g) this.globalConfig.set("firstReqCallbacks", e.mergeArrays(this.globalConfig.get("firstReqCallbacks") || [], [
                    ...
                    return O.superclass.send.call(this, g, b, function() {
                        var b;
    ...
    O.retransmit = function(a) {
        ...
        e.forEachKey(c, function(b, c) {
            ...
            c.ghid && c.ghid != a.get("_globalMetrikaHitId") && c.time && c.time + 864E5 > f && 500 < f - c.time && 2 >= c.browserInfo.rqnl && (d = new O({
                protocol: c.protocol,
                host: c.host,
                resource: c.resource,
    ...
    L.encode = function(a, b) {
        var c = (L.abc + (b ? L.tailSafe : L.tail)).split(""),
            d = a.length,
            f = [],
            g = d - d % 3,
            n;
        for (n = 0; n < g; n += 3) {
            var k = (a[n] << 16) + (a[n + 1] << 8) + a[n + 2];
    ...
    e._hasIndexOf = [].indexOf && -1 === [].indexOf(1);
    ...
    e.warning = function() {
        g.console && "function" === typeof g.console.warn && console.warn.apply(console,
            arguments)
    };
    ...
    r.getSilverlightVersion = function() {
        if (!r._silverlightVersion)
            ...
            } catch (f) {} else if (b = g.navigator, b = b.plugins && b.plugins["Silverlight Plug-In"]) r._silverlightVersion = b.description;
    ...
    var nb = {
        ...
        Pa = {
            ...
            decode: function(a) {
                for (var b =
                    "", c = 0, d, f, e; c < a.length;) d = a.charCodeAt(c), 128 > d ? (b += String.fromCharCode(d), c++) : 191 < d && 224 > d ? (f = a.charCodeAt(c + 1), b += String.fromCharCode((d & 31) << 6 | f & 63), c += 2) : (f = a.charCodeAt(c + 1), e = a.charCodeAt(c + 2), b += String.fromCharCode((d & 15) << 12 | (f & 63) << 6 | e & 63), c += 3);
                return b
            }
        };
    L.decode = function(a, b) {
        for (var c = L.abc + (b ? L.tailSafe : L.tail), d = 0, f = "", e, g, k, h, l; a.length % 4;) a += "\x3d";
        do {
    ...
    var ma = O.inherit({
        ...
        _hitExt: function(a, b) {
            ...
            if (!e.isMetrikaPlayer()) {
                ...
                a.nohit && c("nohit", 1);
                k.ar && !k.onlyData &&
                (l = null === l || "" === l ? "" : this._prepareHitUrl(l), m = this._prepareHitUrl(a.url));
                c("forceNoRedirect", a.forceNoRedirect);
                c("page-ref", e.trim(l, Aa));
                c("page-url", e.trim(m, Aa));
                ...
                c("exp", a.experiments);
                (f = a.vParams) && this.counter && f.__ym && (e.isNumber(f.__ym.turbo_page) && (this.counter.tp = f.__ym.turbo_page), e.isNumber(f.__ym.turbo_page_id) &&
                ...
                f && (m = e.toJSON(f), this.trimParams && m.length > Jb ? g = !0 : m > F.maxBodyLength ? e.warning("Too big params") : c("site-info", m));
        ...
        _getTechInfo: function(a, b, c, d, f, h, n, k, l, t) {
            function q(a, b, c) {
                var d = "" + b;
            ...
            P && q("s", P.width + "x" + P.height + "x" + (P.colorDepth || P.pixelDepth));
            g.devicePixelRatio && q("sk", g.devicePixelRatio);
            r.isIframe() && (q("ifr", "1"), q("sti", r.isSameOriginTopFrame() ?
                "1" : "0"));
            ...
            e.random(100) || q("np", L.encode(Pa.encode(e.trim(r.getPlatform(),
                100))));
            h && q("wh", "1");
            f = "ar ln dl cpf ad nb pa pq pv ex".split(" ");
            for (d = 0; d < f.length; d++) U(f[d]);
            ...
            q("rn", e.random());
            q("hid", n);
            t || 3 == this.counterId || b.pq || q("ds", Db(l));
            l._firstPaint || t ||
            (l._firstPaint = Fb(), q("fp", l._firstPaint));
            if (k) {
                g.name || (g.name = Math.round(65535 * Math.random()));
                if (n = +g.name) 0 > n && (n *= -1), n %= 65535;
                q("wn", n || e.fletcher(g.name));
                try {
        ...
        _getTitle: function(a) {
            a = "undefined" == typeof a ? (a = p.getDocumentTitle()) ? e.trim(a, Ra) : "" : e.trim(a, Ra);
            return a
        }
    });
    ...
    var ha = B.inherit({
        ...
        Kb = O.inherit({
            ...
            retry: !0,
            postParams: ["wv-data"],
            sendPacket: function(a, b, c, d, f,
                                 q, h, k) {
                if (!a || !a.length) return !1;
                var n = L.encode(a, !0);
                if (0 == n.indexOf("AAAAAAAAADw") && g.Error) {
                    var l = Error();
                    "string" == typeof l.stack && (new ha({
                        sampling: .1
    ...
    e.arrayFilter = function(a, b, c) {
        var d = [],
            f;
        for (f = 0; f <
        a.length; f++) b.call(c, a[f], f, a) && d.push(a[f]);
        return d
    };
        ...
        ob = B.inherit({
            ...
            _initComponent: function() {
                if (this.isEnabled()) {
                    ...
                    var b = a.read("visorc");
                    "b" !== b && "w" !== b && (b = "");
                    if (!a.isEnabled() || ta("opera mini")) b = "b";
                    this._vc = b;
                    "b" !== b && (this._recorder = new tb(this.protocol, this.counterId, this.counterType,
                        this.hid, this.globalConfig));
            ...
            _getStorage: function() {
                this._storage || (this._storage = new G({
                    counterId: this.counterId
                }));
                ...
                if (a) {
                    a: {
                        if (a = e.parseUrl(a).host.match(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/))
                            if (a = a[0].split("yandex").reverse()[0].substring(1), -1 != e.arrayIndexOf(F.yandexWhiteListTld, a)) break a;
                        a = !1
                    }
                    a && (this.host = F.baseUrl + a)
                }
            },
            sendHit: function(a) {
                var b = {},
                    c = this._ilStorage.get("il"),
                    d = this._ilStorage.get("pai");
                a.visitColor && (b.vc = a.visitColor);
                c && (this._ilStorage.remove("il"), b.ilt = L.encode(Pa.encode(e.trim(c, pb))));
                d && (this._ilStorage.remove("pai"), b.pai = d);
        ...
        qb = B.inherit({
            ...
            _initComponent: function() {
                ...
                this.syncTlds = e.reduce(function(a, c) {
                    return c(a)
                }, F.yandexWhiteListTld, [e.bind(e.filter, null, function(b) {
                    return b !== a.baseTld
                ...
                e.forEachKey(this.partners, function(a, c) {
                    ...
                    (this.syncTlds[c.tld] || (this.syncTlds[c.tld] = []), this.syncTlds[c.tld].push(a), this._replaceBase[a] = !0)
                }, this)
            },
            _replaceBase: {},
            langToDomain: {
            ...
            _syncAdmetrica: function() {
                var a = F.protocol + "//" + F.admetrikaUrl,
                    b = new V({}),
                    c = this._getLs();
    ...
    var fa = {
            _url: F.protocol + "//" + F.host + "/user_storage_set?",
            _params: {},
            init: function(a) {
                this._params = a || {}
            },
        ...
        Mb = {
            ...
            _enabled: function(a, b, c) {
                if (!(60 < m.getMinutes() - fa.getNum("ds")) || this._is() || e.isDev(this.globalConfig)) return !1;
    ...
    A.dispatchCustomEvent = u(function(a, b) {
        var c;
        b = b || h;
        ...
        na = B.inherit({
            ...
            _initComponent: function() {
                ...
                this.frameConnector && this.frameConnector.addHandler("params", function(a, b) {
                    if (this.counter &&
                        this.counter.params) this.onCookies(function(a) {
                    ...
                    if ((d = a[h]) && d.ymetrikaEvent) {
                        ...
                        if ("params" === n.type && n.data) {
                            ...
                            if (n.counter) this.counter && this.counter.params && this.counterId == n.counter && (this.onCookies(function(a) {
                                this.counter.params(a.data)
                            }, this, e.mixin({}, n)), n.sended.push(this.counterId));
                            ...
                            n.status == this.status.NEW && n.parent && this.frameConnector && this.frameConnector.checkFrame(g.parent) &&
    ...
    var Nb = {
        ...
        ba = B.inherit({
            ...
            handle: function() {
                ...
                if (!this.enabled && ("0" === h || r.isSafariWebView() || r.isAndroidWebView() || e.inArray(Ob, g.location.href.split("?")[0]) || !ea() || f.read("yandex_login") || this.disable)) return f.read("yandex_login") ? this.trigger("GDPR-skip-login") : ea() ? "0" === h ? this.trigger("GDPR-skip") : r.isSafariWebView() || r.isAndroidWebView() ?
                ...
                a.hit(function(a) {
                    ...
                    else return a.params.eu ? k.trigger("GDPR-skip-eu-na") : k.trigger("GDPR-eu-skip"), k.realise(p,
                        b)
                })
            }
        });
    ...
    r.isPrivate = u(function(a) {
        var b = e.bind(a, null, 0),
            c = e.bind(a, null, 1);
        if (e.isFunction(g.webkitRequestFileSystem)) return g.webkitRequestFileSystem(0, 0, b, c);
        if (r.isFF()) try {
            ...
            b()
        } else if (r.isSafari() && e.isFunction(g.openDatabase)) try {
    ...
    r.findTarget = function(a) {
        ...
        for (b = a && a.nodeName && a.nodeName.toString().toLowerCase(); a && a.parentNode && a.parentNode.nodeName && ("a" !== b && "area" !== b || !a.href && !a["xlink:href"]);) b =
    ...
    R.enabled = R._check();
    R.log = u(function() {
        (-1 < K.href.indexOf("_ym_debug\x3d1") || g._ym_debug) && this._cookie.create("debug", "1");
        ...
        Rb = B.inherit({
            ...
            _handler: function(a) {
                ...
                if (this._isTrackingClick(a)) {
                    ...
                    this._sender.sendClick(e.trim(c, Aa), b.join(":"));
                    this._lastClick = a
                }
            },
        ...
        Ta = B.inherit({
            ...
            getInjectHash: function() {
                ...
                e.forEachKey(this.injectHash, function(b) {
                    a[va + ("" + e.fnv32a(b))] = this.injectHash[b]
                }, this);
                return a
            },
            checkAssessor: function() {
                ...
                e.forEachKey(b, function(c) {
                    if ((new RegExp(c)).test(g.location.hash) || G.get(this.ASSESSOR_COOKIE + c)) G.set(this.ASSESSOR_COOKIE + c), a.push(b[c])
                }, this);
                return a
            },
            _initComponent: function() {
        ...
        Sb = {
            match: function() {
                this.enabled() && l.ready(function() {
                    ...
                    a.onload = function() {
                        fa.save("cm", m.getMinutes());
                        p.removeNode(a)
                    };
                    a.style.display = "none";
                    a.src = F.protocol + "//" + F.host + "/metrika/watch_match.html";
                ...
                b.detectAd = function() {
                    ...
                    oa.forEach(function(d) {
                        ...
                        var l = e + k,
                            ...
                            p = 0 > e ? 0 : e < n ? e : n,
                            r = 0 > g ? 0 : g < q ? g : q;
                        100 <= ((l > n ? n : l > p ? l : p) - p) * ((m > q ? q : m > r ? m : r) - r) && v.push({
                            top: g,
                            left: e,
                            width: k,
                            height: f,
    ...
    v.init().setSafe("counters", {}).setSafe("hitParam", {}).setSafe("counterNum", 0).setSafe("dataLayer", []).setSafe("hitId", e.random(1, 1073741824)).setSafe("_globalMetrikaHitId", e.random()).setSafe("v", va);
    g.Ya.Metrika = function(a, b, c, d) {
        ...
        return u(function() {
            function q(a) {
                var b = h.referrer || "",
                    c, d;
                if ((new RegExp("^https?://" + K.host + "/")).test(b)) return !1;
                var f = a.patterns;
            ...
            function F(a, b) {
                ...
                d && (d = -1 < d.indexOf(";") ? e.safeDecodeURIComponent(d) :
                    Pa.decode(L.decode(d.replace(/[-*_]/g, function(a) {
                        return {
                            "*": "+",
                            "-": "/",
                            _: "\x3d"
            ...
            function x() {
                var m = !1;
                Na || (O.initCookie(), nb.init(v));
                la.initPU(da, v);
                r.isAndroidWebView() || la.initPP(v);
                O.retransmit(v);
                Ba && Pb.init(Ba, ja);
                Ra.init(Aa);
                if (v.get("hitParam")[W]) {
                    if (1 != c || v.get("counters")[W]) return !1;
                    m = !0
                }
                v.get("counters")[W] = f;
                v.get("hitParam")[W] = 1;
                ...
                if (!m) {
                    ...
                    var w = function(w) {
                        ...
                        m.sendHit({
                            ...
                            ts: Ha,
                            tz: Ga,
                            callback: function(m, S) {
                                var p;
                                d || (sa = !1);
                                m = m || {};
                                (p = "0" !== m.pcs) || la.initZZ();
                                m.eu !== C && v.set("isEU", m.eu);
                                fa.init(S);
                                Sb.match();
                                Mb.sync(a, c, p, v);
                                R.log("PageView. Counter ", a, ". URL: ", K.href, ". Referrer: " + h.referrer, ". Params: ", b);
                                Ua || (Ua = +new Date);
                                m.webvisor && (m.webvisor.isEU = v.get("isEU"));
                                if (!f.isDestructing()) {
                                    H.start(m.webvisor, m.publisher);
                                    var r = m.mp2;
                                    p = new G({
                                        counterId: a
                                    });
                                            ...
                                            if (Q && Q.length)
                                                for (aa = 0; aa < Q.length; aa++) {
                                                    ...
                                                    if ("ref" == t.type) t = q(t);
                                                        ...
                                                        t = ka ? u.direct_orders : u.direct_camp;
                                                        var z = h.referrer,
                                                            ra = X.parse(K.search),
                                                            B = F(K.search, K.hash),
                                                            D = {};
                                                        var A = ["source", "medium", "campaign", "term", "content"];
                                                        for (E = 0; E < A.length; E++) ra["utm_" + A[E]] && (D[A[E]] = ra["utm_" + A[E]]);
                                                        var I = ka ? "direct.yandex.ru" : B && B.service || D.source;
                                                        E = !1;
                                                        if (!E && x && x.length)
                                                            for (A = 0; A < x.length; A++)
                                                                if ((new RegExp(x[A], "i")).test(I)) {
                                                                    E = !0;
                                                                    break
                                                                }
                                                        if (!E && !u.yandex_direct && y && y.length)
                                                            for (x = 0; x < y.length; x++)
                                                                if ((new RegExp(y[x], "i")).test(z)) {
                                                                    E = !0;
                                                                    break
                                                                }!E && u.google_adwords && ra.gclid && (E = !0);
                                                        if (E && t && t.length && (E = !1, ka = ka || B && B.campaign || D && D.campaign))
                                                    ...
                                                    if (t) {
                                                        Q[aa].track_id && p.create("mp2_track", Q[aa].track_id, 43200);
                                                        break b
                                                    }
                                                }
                                        }
                                        Q = p.read("mp2_track");r = r.substs && r.substs[Q];Q && r ? (p.create("mp2_substs", e.toJSON(r)), p = n(r), f.params("__ym", p ? "mp_trackid" : "mp_trackid_bad", Q)) : k()
                                    } else k();
                ...
                0 != e.keys(y).length && (qa && qa.initUserLayer(), y.enableAll ? (P(!0), T(!0), V()) : (y.clickmap && T(y.clickmap), y.trackLinks && P(y.trackLinks),
            ...
            function Y(a) {
                if (f._trackLinks && f._trackLinks.on) {
                    ...
                    if (c && !p.classNameExists(a, "ym-disable-tracklink")) {
                        var d = b.protocol + "//" + b.hostname + b.pathname;
                        var g = {
                            pai: v.get("pai", e.noop)(),
                            ln: !0
                        };
                        var h = kb(a);
                        h = c === h ? "" : h;
                        if (p.classNameExists(a, "ym-external-link")) N.sendClickLink({
                            url: c,
                            title: h,
                            modes: g
                        }, D);
                            ...
                            g.dl = sb.test(d) || sb.test(c) || lb(c, pa) || lb(d, pa);
                            b = b.hostname;
                            (k ? k.replace(/^www\./, "") : "").toLowerCase() == (b ? b.replace(/^www\./, "") : "").toLowerCase() ? g.dl ? (g.ln = !1,
                                N.sendClickLink({
                                    url: c,
                                    title: h,
                                    modes: g
                                }, D)) : (h = kb(a), Ja.set("pai", g.pai), h && h !== c && Ja.set("il", e.trim(h, pb))) : c && -1 !== c.search(/^ *(data|javascript):/i) || (g.ut = cb, N.sendClickLink({
                                url: c,
                                title: h,
                                modes: g
                            }, D))
            ...
            function V(b) {
                ...
                if (!f._isAccurateTrackBounce) {
                    ...
                    ((e = e.get("lastHit")) && (!g || g < e - 18E5) || !Cb(c, d) || .1 > Math.random()) && ea(function() {
                        f.notBounce()
                    }, b)
                }
            }
            ...
            function va(a) {
                ...
                (function E() {
                    var d = b();
                    d !== c && (a(), c = d);
                    Ka = e.setTimeout(E, 200, "trackHash")
                })()
            }

            function oa(a) {
                if (!1 === a) ia && ("onhashchange" in g ? l.un(g, "hashchange", ua) : e.clearTimeout(Ka), ia = !1);
                else if (a = ua, !ia) {
            ...
            if (!g["disableYaCounter" + a]) {
                ...
                c = c || 0;
                var W = a + ":" + c;
                if (v.get("counters")[W]) return R.log("Duplicate counter " +
                    W + " initialization"), v.get("counters")[W];
                var ja = v.get("hitId");
                var da = new rb({
                    counterId: a,
                    hid: ja
                    ...
                    init: function(a, b) {
                        if (g.performance && "function" === typeof performance.getEntries && (a === C && (a = 1), !(Math.random() >= a))) {
                            ...
                            for (m = 0; m < d.length; m++) {
                                var n = d[m];
                                var p = n.name.replace(/^https?:\/\//, "").split("?")[0];
                                var w = e.fnv32a(p);
                                "script" == n.initiatorType && b && (h[p] = {
                            ...
                            e.keys(l).length && (new ha(k)).logParams(l)
                        }
                    }
                };
                Aa = 24226447 == a ? 1 : .002;
                ...
                f.hit = t(function(b, c, d, g, h, k) {
                    b ? (e.isObject(c) && (d = c.referer, g = c.params, h = c.callback, k = c.ctx, c = c.title), D = b,
                        R.log("PageView. Counter " + a, ". URL: " + b, ". Referrer: " + d, ". Params: ", g), N.sendHit({
                        url: b,
                        title: c,
                        hasPrerender: sa,
                        referrer: d,
                ...
                f.params = t(function(b) {
                    ...
                    if (b) {
                        ...
                        N.sendParams(g[0], h, k, y.url ? D : z().href)
                    } else e.warning("Wrong params");
                    return f
                }, "counter.params");
                da.addHandler("pluginInfo", function() {
                    return y
                }, this);
                da.addHandler("parentConnect", function(a, b) {
                        N.paramsQueue.push({
                            __ym: {
                                parentIframe: {
                ...
                f.addFileExtension = t(function(a) {
                    ...
                    "string" === typeof a ? pa.push(a) : pa = pa.concat(a);
                    return f
                });
                ...
                f.destruct = t(function() {
                    ...
                    T(!1);
                    try {
                        delete g["yaCounter" + a], delete v.get("counters")[W],
                            delete v.get("hitParam")[W]
                    } catch (S) {}
                });
                ...
                if (a) {
                    ...
                    if ("prerender" === h.webkitVisibilityState || "prerender" === h.visibilityState) {
                        ...
                        var hb = function() {
                            ...
                            (l.un(h, "webkitvisibilitychange,visibilitychange", hb), B(!0))
                        };
